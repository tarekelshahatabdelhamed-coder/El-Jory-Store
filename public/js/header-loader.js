...
// ══════════════════════════════════════════════════════
//  Favicon (أيقونة الموقع بجوار الرابط)
// ══════════════════════════════════════════════════════
(function injectFavicon() {
    if (document.getElementById('jory-favicon')) return;
    var link = document.createElement('link');
    link.id = 'jory-favicon';
    link.rel = 'icon';
    link.type = 'image/png';
...
(function injectStyles() {
    ...
    s.textContent = [
        ...
        /* ── Search ── */
        '.jory-search { flex: 1; display: flex; max-width: 480px; margin: 0 auto; border-radius: 10px; overflow: hidden; border: 1.5px solid #e2e8f0; transition: border-color .2s; }',
'.jory-search:focus-within { border-color: #f38c18; }',
        '.jory-search input {',
        ...
        '}',
        '.jory-search input:focus { outline: none; }',
        '.jory-search button {',
...
(function injectHeader() {
    ...
    +       '<button type="submit" id="headerSearchBtn">بحث</button>'
...
(function injectBottomNav() {
    ...
    +     '<span id="botNavHome">الرئيسية</span>'
    +   '</a>'
    ...
    +     '<span id="botNavCats">الأقسام</span>'
    +   '</a>'
